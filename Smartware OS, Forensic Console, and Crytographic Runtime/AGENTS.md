...
| Item | Value |
|------|-------|
| Current version | v2.4.0-m24 alpha (Phase 2 M2.1–M2.4; not a verified product GA ship) |
...
| Next milestone | M2.5 — Fault-Tolerant Execution + Multi-Tenancy |
| Accepted RFCs | RFC-0001…0011 |
